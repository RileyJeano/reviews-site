...
public class ReviewRepository {
	...
	public ReviewRepository() {
		add(new Review(1L, "Greg's Christmas Sweater", "christmas.jpg", "Holliday",
				...
				"12/25/1993"));
		add(new Review(2L, "Greg's College Sweater", "football.jpg", "Historical",
				...
				"05/06/1990"));
		add(new Review(3L, "Greg's Inappropriately Small Sweater", "small.jpg", "Historical",
				...
				"07/12/2003"));
		add(new Review(4L, "Greg's Halloween Sweater", "halloween.jpg", "Holliday",
				...
				"10/04/1998"));
		add(new Review(5L, "Greg's Classy Sweater", "fancy.jpg", "Business Casual",
				"For when it's Friday, but not a casual Friday. This one is an honest argyle Greg found for 10% off at JC Penny back in 1999. He didn't belive in Y2K and wore this sweater to our New Years party that year, but the history rolled off it like water on a duck and it blends in at business meetings better than a bic ballpoint.",
				"03/15/2001"));
	}
